...
Tunnel UDP Sederhana untuk **Minecraft Bedrock Dedicated Server** yang memungkinkan server berjalan di jaringan lokal (NAT/private network) tanpa perlu port forwarding. Dirancang untuk kebutuhan **self-hosting**, terutama ketika server dijalankan dari perangkat Android.
